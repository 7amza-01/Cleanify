const menuOpenButton = document.querySelector('#services-open-button');

const menuCloseButton = document.querySelector('#services-close-button');

menuOpenButton.addEventListener('click', () => {
    document.body.classList.toggle('show-mobile-services');
});
